...
import com.bolivar.bioingenieria.app.sigma_bb.client_hexagon.infrastructure.adapters.output.persistence.mapper.HeadquarterPersistenceMapper;
import com.bolivar.bioingenieria.app.sigma_bb.client_hexagon.infrastructure.adapters.output.persistence.repository.HeadquarterRepository;
...
public class HeadquarterPersistenceAdapter implements HeadquarterPersistencePort {
    ...
    @Override
    public boolean existsById(UUID headquarterId) {
        return headquarterRepository.existsById(headquarterId);
    }
}
