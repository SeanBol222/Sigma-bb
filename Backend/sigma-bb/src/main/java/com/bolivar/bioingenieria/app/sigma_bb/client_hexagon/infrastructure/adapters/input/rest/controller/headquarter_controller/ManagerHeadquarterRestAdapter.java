package com.bolivar.bioingenieria.app.sigma_bb.client_hexagon.infrastructure.adapters.input.rest.controller.headquarter_controller;

import com.bolivar.bioingenieria.app.sigma_bb.client_hexagon.application.ports.input.HeadquarterServicePort;
import com.bolivar.bioingenieria.app.sigma_bb.client_hexagon.infrastructure.adapters.input.rest.mapper.HeadquarterRestMapper;
import com.bolivar.bioingenieria.app.sigma_bb.client_hexagon.infrastructure.adapters.input.rest.mapper.ManagerRestMapper;
...
public class ManagerHeadquarterRestAdapter {

    private final HeadquarterServicePort headquarterServicePort; // Puerto de servicio para la lógica de negocio relacionada con sedes y gerentes
    private final HeadquarterRestMapper headquarterRestMapper; // Mapper para convertir entre DTOs de REST y modelos de dominio relacionados con sedes
    ...
    public ResponseEntity<HeadquarterResponse> addHeadquarterManager(
            @Parameter(
        ...
        return ResponseEntity.ok(
                headquarterRestMapper.toHeadquarterResponse(
                        headquarterServicePort.addManger(
                                idHeadquarter,
                                managerRestMapper.toManagerUseCaseRequest(request))));
    }
