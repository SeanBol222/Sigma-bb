...
import com.bolivar.bioingenieria.app.sigma_bb.client_hexagon.infrastructure.adapters.input.rest.model.request.client_request.ClientCreateRequest;
...
@Mapper(componentModel = "spring",
        ...
        uses = {
                PhoneClientRestMapper.class,
                EmailClientRestMapper.class
        }
)
