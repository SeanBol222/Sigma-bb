...
import com.bolivar.bioingenieria.app.sigma_bb.client_hexagon.infrastructure.adapters.input.rest.mapper.EmailClientRestMapper;
import com.bolivar.bioingenieria.app.sigma_bb.client_hexagon.infrastructure.adapters.input.rest.model.request.client_request.EmailClientCreateRequest;
...
public class EmailClientRestAdapter {
    ...
    private final EmailClientRestMapper emailClientRestMapper; // Mapper para convertir entre DTOs de REST y modelos de dominio relacionados con emailClient
